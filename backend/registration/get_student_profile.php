...
$sql = "SELECT u.username, u.email, u.status, s.fname, s.mname, s.lname, s.date_of_birth, s.age, s.sex, s.grade_level, s.stream, s.address, s.parent_name, s.parent_phone
        FROM users u
...
echo json_encode(['success' => true, 'message' => 'Student profile loaded', 'data' => ['student' => $row]]);
?>
